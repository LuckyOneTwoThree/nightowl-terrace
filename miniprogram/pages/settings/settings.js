...
Page({
  ...
  logout: function () {
    ...
    wx.showModal({
      ...
      success: function (r) {
        if (!r.confirm) return;
        ['predictions', 'boasts', 'checkins', 'court_reactions', 'settings', 'nickname', 'onboarded', 'followedTeams', 'followedLeagues', 'weekSuggest', '_cloudDown', 'cached_scores']
        ...
        var app = getApp();
        app.setFollowed([]);
        app.setFollowedLeagues((data.TOP_LEAGUE_IDS || ['PL', 'PD', 'SA', 'BL', 'FL', 'UCL']).slice());
